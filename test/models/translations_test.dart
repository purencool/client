...
import 'package:app/models/translations.dart';
...
Map<String, Map<String, dynamic>> _testMergeLogic(
  ...
  return {
    for (var key in keys)
      key: {
        for (var registry in registries) ...registry[key] ?? {},
      },
  };
}
...
void main() {
  group('Translations Merging Logic', () {
    test('should merge keys from different registries for the same language', () {
      final registry1 = {
        'english': {'menu': 'Menu'},
        'french': {'menu': 'Menu'},
      };
    ...
    test('should overwrite duplicate keys with values from later registries', () {
      final registry1 = {
